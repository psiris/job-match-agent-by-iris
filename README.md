...
3. Search configuration: role-family queries plus filters.

### Process
1. CV summary prep
Read each family CV and generate a normalized summary used for matching.

2. Search phase (full pipeline universe commitment) across various platforms with applied constraints
A. JSearch (RapidAPI; aggregating LinkedIn and similar boards)
B. ATS/company career pages via web search
